...
namespace gph {
    ...
    private:
        ...
        public:
            ...
            // add a single pixel
            Builder& setPixel(int xPos, int yPos, char symbol, const Rgb textColor, const Rgb backColor);

            // add pixel by raw values (relative index)
            Builder& setPixelByGridIndex(int index, char symbol, const Rgb textColor, const Rgb backColor);

            // fill a zone of a texture by color Id
            Builder& fillTexture(char symbol, const Rgb textColor, const Rgb backColor);
            Builder& fillRow(int yPos, char symbol, const Rgb textColor, const Rgb backColor);
            Builder& fillCol(int xPos, char symbol, const Rgb textColor, const Rgb backColor);
            Builder& addBox(int xPos, int yPos, int xSize, int ySize, char symbol, const Rgb textColor, const Rgb backColor);
